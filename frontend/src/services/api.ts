...
export const transactionApi = {
  ...
  listByDate: (date: string) => api.get('/transactions/by-date', { params: { date } }),
  create: (data: any) => api.post('/transactions', data),
  update: (id: string, data: any) => api.put(`/transactions/${id}`, data),
  delete: (id: string) => api.delete(`/transactions/${id}`),
  batchDelete: (ids: string[]) => api.post('/transactions/batch-delete', { ids }),
}
...
export const searchApi = {
  search: (params: { q: string; type?: string }) => api.get('/search', { params }),
}
...
export const familyApi = {
  ...
  removeMember: (id: string, memberId: string) => api.delete(`/families/${id}/members/${memberId}`),
  getTransactions: (id: string) => api.get(`/families/${id}/transactions`),
  createTransaction: (id: string, data: any) => api.post(`/families/${id}/transactions`, data),
}
...
export const aaGroupApi = {
  ...
  addExpense: (id: string, data: any) => api.post(`/aa-groups/${id}/expense`, data),
...
export const goalApi = {
  ...
  addAmount: (id: string, data: any) => api.post(`/goals/${id}/add-amount`, data),
...
export const cashFlowApi = {
  getProjection: (days = 30) => api.get('/cashflow/projection', { params: { days } }),
}
